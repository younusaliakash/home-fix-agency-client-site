...
const Booking = () => {
  ...
  useEffect(() => {
    fetch(`http://localhost:5000/getService/${_id}`)
    .then(res => res.json())
            ...
            <div className="dashboard-action-area">
              ...
              <Form>
                <Form.Group className="col-6" controlId="formGroupEmail">
                  <Form.Control name="name" type="text" placeholder="Enter name" defaultValue={loggedInUser.displayName} disabled/>
                </Form.Group>
                ...
                <Form.Group className="col-6" controlId="formGroupPassword">
                  <Form.Control name="address" onChange={handleChange} type="text" placeholder="Address"  required/>
                </Form.Group>
                <Form.Group className="col-6" controlId="formGroupPassword">
                  <Form.Control name="phone" onChange={handleChange} type="text" placeholder="Phone number" required/>
                </Form.Group>
              </Form>
