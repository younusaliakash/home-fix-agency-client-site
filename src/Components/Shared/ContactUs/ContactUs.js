            ...
            <Form onSubmit={handleSubmit(onSubmit)}>
              <Form.Row>
                <Form.Group className="col" controlId="formGridEmail">
                  <Form.Control name="name" type="text" placeholder="First Name" {...register("name", { required: true })}/>
              ...
              <Form.Group controlId="formGridAddress1">
                <Form.Control type="text" placeholder="Email" {...register("email", { required: true , pattern: /\S+@\S+\.\S+/ })}/>
